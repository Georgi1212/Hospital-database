...
INSERT INTO FN72039.STAFF(ID, NAME, POSITION, TELEPHONENUMBER, EMAIL, SALARY, DIRECTORHOSPITAL,
...
INSERT INTO FN72039.HOSPITALDEPARTMENTS(NAME, HEADDOCTORID)
...
INSERT INTO FN72039.HOSPITALDEPARTMENTS(NAME, HEADDOCTORID)
VALUES ('ORTOPEDIQ', '6NNIKOLOV1');

INSERT INTO FN72039.HOSPITALPATIENTSROOMS(PATIENTSROOMNUMBER, DEPARTMENTNAME, NUMBERBEDS, NUMBERFREEBEDS)
...
INSERT INTO FN72039.HOSPITALOFFICE(OFFICENUMBER, DEPARTMENTNAME, BUSY, IDSTAFF)
...
INSERT INTO FN72039.PATIENTS(EGN, NAME, GENDER, ADDRESS, TELEPHONENUMBER, HEALTHINSURED, TELK)
...
INSERT INTO FN72039.PATIENTS_HOSPITAL_SERVICE(EGN, DATEARRIVAL, TIMEARRIVAL, PURPOSEVISIT, OFFICENUMBER,
...
INSERT INTO FN72039.HISTORYOFPROCEDURES(EGN, DATEPROCEDURE, TYPEOFPROCEDURE, RESULTOFPROCESURES, DIAGNOSISNAME)
...
INSERT INTO FN72039.CLEANS(SANITARIANID, DEPARTMENTNAME)
VALUES('3IIVANOV31', 'UROLOGIQ');

INSERT INTO FN72039.GOTHROUGH(NURSEID, DEPARTMENT_NAME, PATIENTS_ROOM_NUMBER)
VALUES ('2KDUNEVA21', 'KARDIOLOGIQ', '20306');

INSERT INTO FN72039.HELPS(SANITARIANID, PATIENTEGN)
VALUES ('3IIVANOV31', '6302154584');

INSERT INTO FN72039.TAKINGCAREOF(NURSEID, PATIENTEGN)
...
SELECT *
FROM FN72039.PATIENTS;

SELECT *
FROM FN72039.PATIENTS_HOSPITAL_SERVICE;

SELECT *
FROM FN72039.HISTORYOFPROCEDURES;

SELECT *
FROM FN72039.HOSPITALDEPARTMENTS;

SELECT *
FROM FN72039.HOSPITALPATIENTSROOMS;

SELECT *
FROM FN72039.HOSPITALOFFICE;

SELECT *
FROM FN72039.CLEANS;

SELECT *
FROM FN72039.GOTHROUGH;

SELECT *
FROM FN72039.HELPS;

SELECT *
FROM FN72039.TAKINGCAREOF;